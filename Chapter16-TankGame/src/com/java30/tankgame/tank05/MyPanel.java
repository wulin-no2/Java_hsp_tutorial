...
public class MyPanel extends JPanel implements KeyListener,Runnable {
    ...
    //write a method to check if tanks are overlaped:
//    public boolean tankOverlay(){
//        switch (lina.getDirect()){
//            case 0:
//                if (tank2.direct == 0 || tank2.direct == 2){
//                    if (((x > tank2.x) && (x < tank2.x + 40) &&
//                            (y > tank2.y) && (y < tank2.y + 60))||
//                            ((x + 40 > tank2.x) && (x + 40 < tank2.x + 40) &&
//                                    (y > tank2.y) && (y < tank2.y + 60))
//                    ){
//                        return true;
//                    }else {
...
//
//                }else {
//                    if (((x > tank2.x) && (x < tank2.x + 60) &&
//                            (y > tank2.y) && (y < tank2.y + 40))||
//                            ((x + 40 > tank2.x) && (x + 40 < tank2.x + 60) &&
//                                    (y > tank2.y) && (y < tank2.y + 40))
//                    ){
//                        return true;
//                    }else {
...
//            case 1:
//                if (tank2.direct == 0 || tank2.direct == 2){
//                    if (((x + 60 > tank2.x) && (x + 60< tank2.x + 40) &&
//                            (y > tank2.y) && (y < tank2.y + 60))||
//                            ((x + 60 > tank2.x) && (x + 60 < tank2.x + 40) &&
//                                    (y + 40 > tank2.y) && (y + 40 < tank2.y + 60))
//                    ){
//                        return true;
//                    }else {
//                        return false;
...
//
//                }else {
//                    if (((x + 60 > tank2.x) && (x + 60 < tank2.x + 60) &&
//                            (y > tank2.y) && (y < tank2.y + 40))||
//                            ((x + 60 > tank2.x) && (x + 60 < tank2.x + 60) &&
//                                    (y + 40 > tank2.y) && (y + 40 < tank2.y + 40))
//                    ){
//                        return true;
//                    }else {
//                        return false;
...
//                if (tank2.direct == 0 || tank2.direct == 2){
//                    if (((x > tank2.x) && (x < tank2.x + 40) &&
//                            (y + 60> tank2.y) && (y + 60 < tank2.y + 60))||
//                            (( + 40 > tank2.x) && (x + 40 < tank2.x + 40) &&
//                                    (y + 60 > tank2.y) && (y + 60 < tank2.y + 60))
//                    ){
//                        return true;
//                    }else {
